...
//import { useBalance, useTotals } from "../../stores/useExpenseStore"; // Importaciones problematicas
...
function BalanceContent() {
  ...
  * Valores fijos para testing  
   const totals = {
    income: 80,
    expense: 100,
  };*/
  //const totals = useTotals(); // Selector problematico
  /* Análisis técnico del Error
   * problema 1: Código comentado con valores de prueba que confunden
   * problema 2: Uso de Selectores que causan bucles infinitos
   * impacto: Los datos mostrados no reflejan las transacciones reales
   */
  ...
  const totals = transactions.reduce(
    (acc, t) => {
      acc[t.type] = (acc[t.type] || 0) + t.amount; // Manejo seguro de undefined
      return acc;
    },
    { income: 0, expense: 0 },
  );
